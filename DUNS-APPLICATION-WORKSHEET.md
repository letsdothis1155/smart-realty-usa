...
| Step | URL |
|------|-----|
| Lookup first | https://www.dnb.com/en-us/smb/duns/duns-lookup.html |
| Lookup alt | https://my.dnb.com/lookup |
| Get free D‑U‑N‑S | https://www.dnb.com/en-us/smb/duns/get-a-duns.html |
| Choose | **I have a U.S.-based business** |
| D&B phone (confirm on site) | 1-800-591-8534 |
...
## Suggested industry wording (pick closest on their list)
...
## Click path (do this now)

1. Open **Lookup**: https://www.dnb.com/en-us/smb/duns/duns-lookup.html  
2. Search **legal name** + city.  
   - Found → claim it.  
   - Not found → continue.  
3. Open **Get a D‑U‑N‑S**: https://www.dnb.com/en-us/smb/duns/get-a-duns.html  
4. **Get Started** → **I have a U.S.-based business**  
5. Paste values from the tables above  
6. **Do not buy** credit packages unless you want them  
7. **Skip expedite** unless you need the number in ~8 business days  
8. Submit → watch email/spam for Dun & Bradstreet  
9. When you get the **9-digit number**, reply here — I’ll put it on the website
...
## Why I can’t “fill it out on D&B for you”

- Requires **your** real legal identity and address  
- D&B may **call/email you** to verify  
- Submitting made-up or someone else’s details would be fraud  
- Only a verified owner/officer should submit  

If you paste your real blanks (legal name, address, your name, phone, year started, entity type), I will rewrite this worksheet as a **complete copy-paste sheet** with every field finished for you to submit yourself in under 10 minutes.
