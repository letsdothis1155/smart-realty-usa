...
(function () {
    ...
    <header class="g-header">
      <div class="container g-header-inner">
        ...
        <nav class="g-nav" id="gNav">
          ${link("/", "Homes", "home")}
          ${link("/new-listings/", "Live listings", "listings")}
          ${link("/room-builder/", "3D Room", "room-builder")}
    ...
    <footer class="g-footer">
      <div class="container g-footer-grid">
        ...
        <div>
          ...
          <a href="/apps/daily-cache-wiper/">Daily Cache Wiper</a>
          <a href="/apps/axiom/">Axiom</a>
          <a href="/new-listings/">New listings</a>
          <a href="/build/">3D Home Builder</a>
          <a href="/room-builder/">3D Room Builder</a>
  ...
  const boots = {
    ...
    "room-builder": () => {
      G()?.track("room_builder_view", {});
      bootProductPage("room-builder", "room-builder");
    },
    "new-listings": () => bootProductPage("new-listings", "new-listings"),
    "listing-3d": () => bootProductPage("listing-3d", "listing-3d"),
    start: () => bootProductPage("start", "start"),
    apps: () => bootProductPage("apps", "apps"),
  };
  if (page && boots[page]) {
